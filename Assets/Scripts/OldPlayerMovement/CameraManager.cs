...
public class CameraManager : MonoBehaviour
{
    ...
    public LayerMask collisionLayers; // The layers the camera should collide with
    private float defaultPosition;// The object the camera pivots with
    private Vector3 cameraFollowVelocity = Vector3.zero;
    private Vector3 cameraVectorPosition;

    public float cameraCollisionOffset = 0.2f; // How much the camera comes off objects it collides with
