...
namespace SlimUI.ModernMenu{
	public class UIMenuManager : MonoBehaviour {
        ...
        [Tooltip("The first selected button")]
        public GameObject firstSelected;
        [Tooltip("The first selected options button")]
        public GameObject firstOptionsSelected;
...
#pragma warning restore CS0414 // Field is assigned but its value is never used
		...
		[Tooltip("The UI Panel that holds the GRAPHICS window tab")]
		...
		[Tooltip("Highlight Image for when GRAPHICS Tab is selected in Settings")]
		...
		public void LoadNewGame(string scene)
		{
			NewGame.Instance.isNewGame = true;
		...
		public void ContinueGame()
		{
			...
			bool level2;
			if (!reader.TryRead("Level2", out level2)) return; // Return if no save data

			StartCoroutine(level2 ? LoadAsynchronously("Level2") : LoadAsynchronously("Level1-2Demo"));
		}
		...
		public void Position2(){
			EventSystem.current.SetSelectedGameObject(firstOptionsSelected);
		...
		public void SetDefaultButton(GameObject newButton)
		{
